...
def main():
    ...
    training_As_csr = generate_matrices(n_samples, size_A, size_A, matrix_type)
    total_norm = 0.
    ...
    train(training_As_csr, S, P_baseline_list, coarse_nodes_list, learning_rate)
...
def train(As_csr, S, P_baseline_list, coarse_nodes_list, lr):
    ...
    for csr, coarse_nodes, P_baseline in zip(As_csr, coarse_nodes_list, P_baseline_list):
        ...
        P_baseline_rows, P_baseline_cols = ut.P_square_sparsity_pattern(P_baseline, n_node, coarse_nodes)
        coo = csr.tocoo()
...
def loss(A, S, P_square, P_baseline, coarse_nodes):
    ...
    M = ut.two_grid_error_matrix(A, P, S)
